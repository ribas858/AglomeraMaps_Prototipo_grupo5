        ...
        <Block flex>
          ...
          <Block space="between" style={styles.padded}>
            <Block>
              ...
              <Block >
                <Block>
                  <Text color="white" size={60}>Versão</Text>
                </Block>
                <Block>
                  <Text color="white" size={60}>De Testes</Text>
                </Block>
                <Block row>
              ...
              <Text size={16} color='rgba(255,255,255,0.6)' style={{ marginTop: 35 }}>
                Aplicativo desenvolvido com o intuito de informar as pessoas sobre locais cheios a fim de evitar aglomerções
              </Text>
